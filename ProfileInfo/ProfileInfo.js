...
export default function ProfileInfo({navigation , user , userId , image : initialImage}) {
    ...
    const pickImage = async () => {
      ...
      const endpointUrl = 'https://todoapp-react-native.mohamedkacem1.repl.co/tasks/users/'+userId+'/photo'; // Replace with your server URL
  ...
  return (
    ...
    {image ? (
          ...
          <Image source={{ uri: initialImage }} style={styles.img} />
        )}
